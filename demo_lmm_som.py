#   MODIFIED VERSION OF DEMO FOR RESEARCH PURPOSES
#
# --------------------------------------------------------
...
history_masks = []
history_texts = []
current_model = None  # Track the current segmentation model
...
def geminipro_response(message, history):
    ...
    try:
        ...
        res = request_genai_model("gemini-1.5-pro", message, pil_image=pil_image, files=files)
        return res
    except Exception as e:
        print(e)
        return None
